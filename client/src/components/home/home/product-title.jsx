    ...
    <Box sx={{ flexGrow: 1}}>
        ...
        <Grid item xs={12} md={12} lg={6}>
          <Item sx={{backgroundColor:"#04AFB6",boxShadow:"none"}}>
            ...
            <Stack direction={'row'} spacing={-2.2}>
              {/* first*/}
              <Item sx={{backgroundColor:"#04AFB6",boxShadow:"none"}}>
                <Typography variant="h3" gutterBottom sx={{fontWeight:"bold", color:"#ffffff",fontSize:"6rem"}}>
                  Food
                </Typography>
              </Item>
              ...
              <Stack direction={'column'} spacing={-3}>
                <Item sx={{backgroundColor:"#04AFB6",boxShadow:"none"}}>
                  {/* first*/}
                  <Typography variant="h5" gutterBottom sx={{color:"#000000",fontWeight:"bold",fontSize:"2rem"}}>
                    Ordering
                    </Typography>
                </Item>
                <Item sx={{backgroundColor:"#04AFB6",boxShadow:"none"}}>
      ...
      <Grid item xs={12} md={12} lg={12}>
        ...
        <Typography variant="subtitle1" gutterBottom sx={{fontWeight:"bold"}}>
          Now order your food in advance so you can have it instantly, order now in VFood.
        </Typography>
        </Item>
      </Grid>
      {/*fourth button*/}
