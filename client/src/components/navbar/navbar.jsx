...
function DrawerAppBar(props) {
  ...
  const drawer = (
    <Box onClick={handleDrawerToggle} sx={{ textAlign: "center",backgroundColor:"#04AFB6",height:"150vh",fontWeight:"bold"}}>
      {/*Logo Name*/}
  ...
  return (
    <Box sx={{ display: "flex" }}>
      <AppBar component="nav" sx={{backgroundColor:"#04AFB6",boxShadow:"none"}}>
        <Toolbar>
          <IconButton
            color="inherit"
